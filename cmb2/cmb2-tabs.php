...
if (!class_exists('CMB2_Tabs')) {
  ...
  class CMB2_Tabs {
    ...
    /**
     * Initialize by hooking into CMB2
     */
...
<?php endif;
    ...
    public function setup_admin_scripts() {
      wp_register_script('cmb-tabs', get_stylesheet_directory_uri() . '/cmb2/js/tabs.js', array('jquery'), self::VERSION, true);
      wp_enqueue_script('cmb-tabs');

      wp_enqueue_style('cmb-tabs', get_stylesheet_directory_uri() . '/cmb2/css/tabs.css', array(), self::VERSION);
    ...
    //   wp_enqueue_style('cmb-tabs-dark-mode', get_stylesheet_directory_uri() . '/cmb2/css/dark-mode.css', array(), self::VERSION);
